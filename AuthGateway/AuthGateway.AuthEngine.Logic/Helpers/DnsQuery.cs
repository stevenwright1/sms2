...
{
	// http://randronov.blogspot.co.uk/2013/03/lookup-srv-record-in-c.html
	public class NsLookup
	{
		...
		public static IList<string> GetSRVRecords(string needle)
		{
			...
			try
			{
				...
				int num1 = NsLookup.DnsQuery(ref needle, QueryTypes.DNS_TYPE_SRV, QueryOptions.DNS_QUERY_BYPASS_CACHE, 0, ref ptr1, 0);
				if (num1 != 0)
				{
					if (num1 == 9003)
			...
			{
				NsLookup.DnsRecordListFree(ptr1, 0);
			}
			return retList;
		}
