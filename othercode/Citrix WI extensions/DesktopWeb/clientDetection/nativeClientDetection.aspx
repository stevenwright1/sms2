...
<script runat="server">
    void Page_Load(object sender, System.EventArgs e) {
        (new NativeDetectionController(wizardContext)).perform();
...
<%@ Register Src="~/app_data/clientDetection/clientscripts/nativeClientDetectionPageClientScript.ascx" TagName="ClientScript" TagPrefix="wizard" %>
