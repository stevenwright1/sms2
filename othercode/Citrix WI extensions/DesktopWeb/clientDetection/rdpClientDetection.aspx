...
<script runat="server">
    void Page_Load(object sender, System.EventArgs e) {
        (new RdpDetectionController(wizardContext)).perform();
...
<%@ Register Src="~/app_data/clientDetection/clientscripts/rdpClientDetectionPageClientScript.ascx" TagName="ClientScript" TagPrefix="wizard" %>
