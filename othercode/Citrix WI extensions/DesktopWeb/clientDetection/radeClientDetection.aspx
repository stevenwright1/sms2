...
<script runat="server">
    void Page_Load(object sender, System.EventArgs e) {
        (new RadeDetectionController(wizardContext)).perform();
...
<%@ Register Src="~/app_data/clientDetection/clientscripts/radeClientDetectionPageClientScript.ascx" TagName="ClientScript" TagPrefix="wizard" %>
