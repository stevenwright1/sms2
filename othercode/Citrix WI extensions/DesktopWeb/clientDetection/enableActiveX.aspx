...
<script runat="server">
    void Page_Load(object sender, System.EventArgs e) {
        (new EnableActiveXController(wizardContext)).perform();
        ...
        master.PageID = WizardConstants.PAGE_ID_ENABLE_ACTIVEX;
        master.HorizonLayoutPage = true;
    }
</script>

<%@ Register Src="~/app_data/clientDetection/clientscripts/enableActiveXPageClientScript.ascx" TagName="ClientScript" TagPrefix="wizard" %>
<%@ Register Src="~/app_data/clientDetection/include/enableActiveXPageView.ascx" TagName="PageView" TagPrefix="wizard" %>
