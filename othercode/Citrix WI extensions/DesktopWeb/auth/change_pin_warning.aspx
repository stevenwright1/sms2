...
<script runat="server">
    void Page_Load(object sender, System.EventArgs e) {
        layout.PageClientScript = "~/auth/clientscripts/change_pin_warningClientScript.ascx";
        layout.PageView = "change_pin_warningView.ascx";
    }
</script>

<%
if (!(new com.citrix.wi.pages.auth.twofactor.ChangePinWarning(wiContext).perform())) {
    return;
}
%>
