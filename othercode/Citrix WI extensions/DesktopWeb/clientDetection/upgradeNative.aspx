...
<script runat="server">
    void Page_Load(object sender, System.EventArgs e) {
        (new UpgradeNativeController(wizardContext)).perform();
        ...
        master.PageID = WizardConstants.PAGE_ID_UPGRADE_NATIVE;
        master.HorizonLayoutPage = true;
    }
</script>

<%@ Register Src="~/app_data/clientDetection/clientscripts/upgradeNativePageClientScript.ascx" TagName="ClientScript" TagPrefix="wizard" %>
<%@ Register Src="~/app_data/clientDetection/include/upgradeNativePageView.ascx" TagName="PageView" TagPrefix="wizard" %>
