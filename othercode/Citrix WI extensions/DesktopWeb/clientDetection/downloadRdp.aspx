...
<script runat="server">
    void Page_Load(object sender, System.EventArgs e) {
        (new RdpDownloadController(wizardContext)).perform();
        ...
        master.PageID = WizardConstants.PAGE_ID_DOWNLOAD_RDP;
    }
</script>

<%@ Register Src="~/app_data/clientDetection/clientscripts/downloadRdpPageClientScript.ascx" TagName="ClientScript" TagPrefix="wizard" %>
<%@ Register Src="~/app_data/clientDetection/include/downloadRdpPageView.ascx" TagName="PageView" TagPrefix="wizard" %>
