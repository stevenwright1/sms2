...
<script runat="server">
    void Page_Load(object sender, System.EventArgs e) {
        (new PopupHelpController(wizardContext)).perform();
        ...
        master.PageID = WizardConstants.PAGE_ID_POPUP_HELP;
    }
</script>

<%@ Register Src="~/app_data/clientDetection/clientscripts/popupHelpPageClientScript.ascx" TagName="ClientScript" TagPrefix="wizard" %>
<%@ Register Src="~/app_data/clientDetection/include/popupHelpPageView.ascx" TagName="PageView" TagPrefix="wizard" %>
